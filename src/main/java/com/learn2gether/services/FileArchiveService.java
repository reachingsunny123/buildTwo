...
import com.learn2gether.exception.FileArchiveServiceException;
...
public class FileArchiveService {
	...
	private static final String S3_BUCKET_NAME = "learn2gether-customer-images-dev";
	...
	public CustomerImage saveFileToS3(MultipartFile multipartFile) throws FileArchiveServiceException {
		...
		try{
			...
			return new CustomerImage(key, signedUrl.toString());//signedUrl.toString());
		}
		catch(Exception ex){			
